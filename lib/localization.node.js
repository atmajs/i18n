...
var _src_localizer_NodeLocalizer = {};
var _src_node_middleware = {};
...
if (include == null) {
    require('includejs');
    exports.include = include = g.include;
}
if (mask == null) {
    exports.mask = mask = require('maskjs');
}
//#endif
if (format == null) {
    ...
    //#if (NODE)
    if (format == null) {
        exports.format = format = require('atma-formatter');
    }
    //#endif
}
if (format == null) {
...
function localizer(isoCode) {
    ...
    if (translation == null)
        console.error('<localization> Translation is not defined for', isoCode);
    var fn = function (key) {
        var args = [];
...
;
function lang_extend(isoCode, translations) {
...
exports.NodeLocalizer = function () {
    var args = [];
    for (var _i = 0; _i < arguments.length; _i++) {
        args[_i] = arguments[_i];
    }
    console.warn('<localizer> In node env. please call $L.fromReq(req)("someKey")');
    return Factory_1.localizer_create(Config_1.default.lang || Config_1.default.support[0]);
};
exports.NodeLocalizer.loadSingle = SourceFactory_1.SourceFactory.loadSingle;
exports.NodeLocalizer.config = function (opts) {
    if (opts.lang) {
        Config_1.default.lang = opts.lang;
    }
    if (opts.support) {
...
// 	}
// }
exports.NodeLocalizer.fromReq = function (req) {
    if (req.$L !== void 0)
        return req.$L;
    var lang = detect_1.detect_fromRequest(req), localizer = Factory_1.localizer_create(lang);
...
;
	...
	if (isObject(_src_localizer_NodeLocalizer) && isObject(module.exports)) {
		Object.assign(_src_localizer_NodeLocalizer, module.exports);
		return;
	}
	_src_localizer_NodeLocalizer = module.exports;
}());
// end:source ./ModuleSimplified.js
...
Object.defineProperty(exports, "__esModule", { value: true });
var global_1 = _src_global;
var NodeLocalizer_1 = _src_localizer_NodeLocalizer;
var SourceFactory_1 = _src_sources_SourceFactory;
if (global_1.isNode) {
    /* { path, support } */
    NodeLocalizer_1.NodeLocalizer.middleware = function (config) {
        return function (req, res, next) {
            SourceFactory_1.SourceFactory
                .loadSingle(config, req)
                .done(function () {
                req.$L = NodeLocalizer_1.NodeLocalizer.fromReq(req);
                next();
            });
        };
    };
...
;
	...
	if (isObject(_src_node_middleware) && isObject(module.exports)) {
		Object.assign(_src_node_middleware, module.exports);
		return;
	}
	_src_node_middleware = module.exports;
}());
// end:source ./ModuleSimplified.js
...
//#if (NODE)
var NodeLocalizer_1 = _src_localizer_NodeLocalizer;
_src_node_middleware;
exports.default = NodeLocalizer_1.NodeLocalizer;
//#endif 
/*#if (BROWSER)
...
exports.mask_util = function (key, model, ctx) {
    //#if (NODE)
    return localize(L_1.default.fromReq(ctx.req), arguments);
    //#endif
    /*#if (BROWSER)
